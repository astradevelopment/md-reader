...
Полоса вкладок тянется до контролов: из ширины панели вычитаются оправа тулбара
(112) и место под контролы (200 в покое, больше — когда открыт поиск). Доля
панели служит лишь верхним пределом и в обычных размерах окна не срабатывает.
Число вкладок отсюда получается само: ширина вкладки делится на всех, пока не
упрётся в 96 pt, дальше лишние уходят под шеврон.
