...
| `FileRename` | что набрали в поле имени → куда двигать файл или почему нельзя |
| `RightClickMenu` | меню по правой кнопке там, где его забирает тулбар |
| `DocumentStore` | вкладки, выделение, сессия, позиции чтения, недавние файлы, переименование |
...
| `TabStrip` | вкладки, переполнение, предпросмотр при наведении, меню по правой кнопке |
